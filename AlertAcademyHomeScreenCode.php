...
<script type=“text/javascript”>
	...
	<h1 align="center">Alert Academy</h1>
		<!-- Navigation -->
		<div class="sidebar">
			<a class="active" href="profile">Profile</a> <!--Add in the command for the profile section, Angelu-->
			<a href="home">Home</a> <!-- Try to add another code to return to the Home Screen even though it already in the Home Screen, Angelu-->
